<script lang="ts">
	...
	let new_variables = theme ? theme.variables : []; // TODO `updateVariables` to `ThemeVariableDetail` ?
	...
	let selected_variable: ThemeVariable | null = null;
	...
	const edit_variable = (e: MouseEvent, variable: ThemeVariable): void => {
		swallow(e);
	...
	<Dialog on:close={() => (selected_variable = null)} let:close>
		<div class="pane">
			<div class="panel padded_lg box">
				<ThemeVariableDetail variable={selected_variable} />
				<br />
